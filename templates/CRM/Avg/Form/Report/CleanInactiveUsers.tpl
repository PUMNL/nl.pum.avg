            ...
            {literal}
              <script>
                cj(document).ready(function(){
                  cj('#CleanInactiveUsers input[id=chkSelectAll]').click(function(){
                    if(cj('#CleanInactiveUsers input[id=chkSelectAll]').prop('checked') == false) {
                      cj('#CleanInactiveUsers input[class=chkUser]').prop('checked',false);
                    }
                    if(cj('#CleanInactiveUsers input[id=chkSelectAll]').prop('checked') == true) {
                      cj('#CleanInactiveUsers input[class=chkUser]').prop('checked',true);
                    }
                  });
                });
              </script>
